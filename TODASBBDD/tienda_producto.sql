...
CREATE TABLE `producto` (
  ...
  CONSTRAINT `producto_ibfk_1` FOREIGN KEY (`codigo_fabricante`) REFERENCES `fabricante` (`codigo`) ON DELETE CASCADE ON UPDATE CASCADE
...
-- Dump completed on 2024-10-28 16:14:14
